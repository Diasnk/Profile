...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <a href="#experience" onClick={() => setActiveNav('#experience')} className={activeNav === '#experience' ? 'active' : ''}><MdOutlineBookmarks></MdOutlineBookmarks></a>
      ...
      <a href="#portfolio" onClick={() => setActiveNav('#portfolio')} className={activeNav === '#portfolio' ? 'active' : ''}><GiPlagueDoctorProfile></GiPlagueDoctorProfile></a>
